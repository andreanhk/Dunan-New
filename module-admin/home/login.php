<?php
    ...
    if(!empty($_SESSION['id'])) echo "<script> window.location='".$root.HOME."index.php' </script>";
?>
...
<body>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b><center>Please Login</center></b></h3>
                    </div>
    ...
    <!-- jQuery -->
    <script src="<?php echo $root; ?>assets-admin/bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo $root; ?>assets-admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="<?php echo $root; ?>assets-admin/bower_components/metisMenu/dist/metisMenu.min.js"></script>
